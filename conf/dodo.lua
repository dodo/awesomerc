...
return {
    ...
    phone = {'ae28d977c3c41ed6'}, -- show phone battery
    ...
    mpris = uzful.util.module.exists('mpris'), -- use mpris client
    freedesktop = true, -- show freedekstop menu
    ...
    wireless = 'wlp2s0',
    notifications = false,--true, -- widget to block notifications and store a history of them
